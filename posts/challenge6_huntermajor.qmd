...
ggplot(debt4, aes(x= Date, y=Total))+
  ...
  labs(title= "Total Debt from 2003-2021", x= "Date", y= "Debt, in trillions")+
...
Next, we'll use stacked bar plots to visualize Debt (in trillions) by Year sorted by Debt_Type and Quarter. This type of plot is useful for displaying multiple variables simultaneously, "split into groups and subgroups" (Holtz, 2018).
...
# Stacked Bar Plot of Debt over Year sorted by Debt Type
ggplot(debt6, aes(x= Date, y= `Debt_Amount`, fill= Debt_Type))+
  geom_bar(position= "stack", stat= "identity")+
  labs(x= "Year", y= "Debt, in trillions", fill= "Debt Type", title= "Stacked Bar Plot of Debt over Year sorted by Debt Type")+
  theme_minimal()

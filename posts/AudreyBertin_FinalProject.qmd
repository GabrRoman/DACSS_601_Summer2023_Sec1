...
In order to look at details by team, we'll need to do some additional modification to our data. From 2016 - 2022, there are quite a few different team names recorded in the data:
...
We can then calculate average start position for each team and use that to calculate who is starting out of position:

...
The goal of the project will be to find attributes that best predict success in the game. We would want to see the following aspects: 
...
```{r}
nrow(prem_2023_shooting)
```
```{r}
table(prem_2023_shooting$Team_or_Opponent)
```

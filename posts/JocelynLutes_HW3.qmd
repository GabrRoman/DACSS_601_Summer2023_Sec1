...
Across these five categories, the full NHANES dataset includes approximately 94 tables, but we will only use 12 tables for our analysis. All of the tables can be easily joined using the subject's unique identification number.
